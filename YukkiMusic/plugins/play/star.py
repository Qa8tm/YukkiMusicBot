...
@Client.on_message(command(["ping", f"ping@{BOT_USERNAME}", "بنج"]) & ~filters.edited)
...
@Client.on_message(command(["uptime", f"uptime@{BOT_USERNAME}", "وقت التشغيل"]) & ~filters.edited)
